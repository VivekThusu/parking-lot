...
class SlotNumbersForDriverInstructionTest {
    ...
    private final SlotNumbersForDriverInstruction slotNumbersForDriverInstruction =
            new SlotNumbersForDriverInstruction();
    ...
    void perform_whenVehiclePresent_thenReturnParkingSlots() {
        ...
        String message = slotNumbersForDriverInstruction.perform(parkingLot, ParkingSpace.builder()
                .driverAge(26).build());
    ...
    void perform_whenVehicleNotPresent_thenReturnNull() {
        ...
        assertEquals("null", slotNumbersForDriverInstruction.perform(parkingLot, parkingSpace));
    }
}